...
void failo_nuskaitymas(const std::string& pav, std::list<Student>& studentai)
{
    std::ifstream rf(pav);
...
int main()
{
    ...
    std::list<Student> studentai, kietekai, vargsiukai;
    failo_nuskaitymas("studentai_10000.txt", studentai);
    padalinti1(studentai, kietekai, vargsiukai);
    issaugoti_studentus(studentai, "studentai_issaugoti_list.txt");
